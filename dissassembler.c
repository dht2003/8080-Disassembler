// File: dissassembler.c
// Description : implementation of dissessembler functions 
...
int dissassembler8080p(code *program) {
    ...
    switch (*opcode) {
       case 0x00: printf("NOP"); break;
        ...
        case 0x27: printf("DDA"); break;
        case 0x28: printf("NOP"); break;
        case 0x29: printf("DAD H"); break;
        case 0x2a: printf("LDHD $%02x%02x", opcode[2],opcode[1]); opbytes = 3; break;
        ...
        case 0x68: printf("MOV L,A"); break;
